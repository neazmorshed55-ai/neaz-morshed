...
DROP TABLE IF EXISTS skill_gallery CASCADE;
...
CREATE INDEX idx_sub_skills_slug ON sub_skills(category_id, slug);
CREATE INDEX idx_sub_skills_active ON sub_skills(is_active);
CREATE INDEX idx_skill_gallery_sub_skill_id ON skill_gallery(sub_skill_id);
CREATE INDEX idx_skill_gallery_order ON skill_gallery(sub_skill_id, order_index);
...
-- ============================================
-- Insert Data with is_active = true
-- ============================================
