...
export default function WhatsAppButton() {
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-6 right-24 z-[9998] w-16 h-16 rounded-full shadow-2xl flex items-center justify-center bg-[#25D366] hover:bg-[#20bd5a] transition-colors"
